  ...
  const cardBody = (
    <View style={[styles.productCardInner, { height: cardHeight }]}>
      <View style={[styles.productLeftCol, { width: leftColWidth }]}>
        ...
        {showTutorialTargets ? (
          <MarketTutorialTarget id={priceTargetId} layoutMode="stretch">
        ...
        {showTutorialTargets ? (
          <MarketTutorialTarget id={buyTargetId} layoutMode="content">
            ...
            >
              ...
              <Text style={styles.productBuyBtnText} numberOfLines={2}>
                {buyButtonLabel}
              </Text>
            </Pressable>
          </MarketTutorialTarget>
...
export default function MarketScreen({ onOpenContracts }: MarketScreenProps) {
  ...
  const { scrollBottomPadding: marketScrollBottomPadding } = useTabBarLayout();
