  ...
  first_contract: {
    ...
    steps: [
      ...
      },
      {
        ...
        title: 'Uygun işi seç',
        description: 'Bu kart başlangıç için uygun. İş detayını açmak için dokun.',
  ...
  market_basics: {
    ...
    steps: [
      ...
      },
      {
        ...
        fallbackTargetIds: ['market-first-product', 'market-products-section', 'tab-market'],
        ...
        showPointer: true,
        targetPadding: 8,
        fallbackTitle: 'Ürün piyasası',
        fallbackDescription: 'Fiyatları buradan takip et. Ucuzken al, pahalıyken sat.',
      },
    ],
  },
};
