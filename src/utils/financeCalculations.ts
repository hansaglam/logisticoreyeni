...
const CATEGORY_LABELS: Partial<Record<FinanceLedgerCategory, string>> = {
  contract_revenue: 'Sözleşme Geliri',
  contract_income: 'Sözleşme Geliri',
  delivery_income: 'Sözleşme Geliri',
  market_sale: 'Piyasa Satışı',
  trade_sale: 'Ticaret Geliri',
  bonus: 'Bonus',
  reward: 'Ödül',
  recovery_assistance: 'Kurtarma Yardımı',
  other_income: 'Diğer Gelir',
  fuel_purchase: 'Yakıt Alımı',
  roadside_fuel: 'Acil Yakıt',
  fuel: 'Yakıt',
  delivery_expense: 'Yakıt',
  maintenance: 'Bakım',
  penalty: 'Ceza',
  market_purchase: 'Piyasa Alımı',
  trade_purchase: 'Ürün Alımı',
  driver_salary: 'Şoför Maaşı',
  warehouse_cost: 'Depo Gideri',
  ...
  truck_sale: 'Kamyon Satışı',
  driver_hire: 'Şoför İşe Alım',
  driver_severance: 'Şoför Çıkış Maliyeti',
